...
|[@extended](#extended)|Generates the extended format instead of the short one| No| Yes|
...
|[@brief ](#brief)|Specifies brief description method/property/notification or parameter or POD structure member | No| Yes|Method, Parameter, POD member |
...
To avoid create a proxy implementation for a function mark it with this tag.
